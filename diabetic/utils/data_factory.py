...
if __name__ == "__main__":
    ...
    if "--test-projection" in sys.argv:
        ...
        print(f"[VERIFY] Velocity: {result['velocity']} mmol/L/min")
        print(f"[VERIFY] Acceleration: {result['acceleration']} mmol/L/min²")
        print(f"[VERIFY] P15m: {result['p15m']} | P30m: {result['p30m']} | P60m: {result['p60m']}")
        print(f"[VERIFY] Confidence Index: {confidence}")
