...
- **Raw API Secret**: `bioq_tam2026`
- **CGM Uploader Secret (SHA-1)**: `97c161991d8c547090c0f65e8e052bff9e1d36c5`
- **Direct Entry Webhook**: `https://hpdesk-1.tail285cce.ts.net/api/v1/entries?secret=97c161991d8c547090c0f65e8e052bff9e1d36c5`
...
4. **CGM App Settings**:
   ...
   - **Raw API Secret**: `bioq_tam2026`
   - **API Secret (SHA-1)**: `97c161991d8c547090c0f65e8e052bff9e1d36c5`
